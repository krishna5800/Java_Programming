...
class StudyTracker
{
    ...
    public void SummaryByDate()
    {
        ...
        if(Database.isEmpty())
        {
            System.out.println("Nothing to display as databse is empty");
            System.out.println("-----------------------------------------------------------------");
            return;
        }

        System.err.println("--------------- Summary by date from study tracker --------------");
        System.out.println("-----------------------------------------------------------------");
        ...
        for(LocalDate str : tobj.keySet())
        {
            System.out.println("Date : " + str + " | " + "Total study duration : "+ tobj.get(str));
        }
    ...
    public void SummaryBySubject()
    {
        ...
        System.err.println("------------- Summary by subject from study tracker -------------");
        System.out.println("-----------------------------------------------------------------");
...
class program902
{
    public static void main(String A[])
    {
        ...
        }while(iChoice != 5); // End of do-while
