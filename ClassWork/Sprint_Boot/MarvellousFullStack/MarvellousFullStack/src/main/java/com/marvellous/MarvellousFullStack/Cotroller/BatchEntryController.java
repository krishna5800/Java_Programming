package com.marvellous.MarvellousFullStack.Cotroller;
...
public class BatchEntryController
{
    ...
    @PostMapping
    public ResponseEntity<BatchEntry> create(@RequestBody BatchEntry myentry)
    {
        try
        {
    ...
    public ResponseEntity<?> deleteEntryById(@RequestBody ObjectId myid)
    {
